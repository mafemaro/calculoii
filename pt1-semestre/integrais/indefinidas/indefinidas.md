...
- Derivar → calcula a taxa de variação  
- Integrar → reconstrói a função original  
...
- ❌ Esquecer o $+C$  
- ❌ Aplicar regras de potência incorretamente  
- ❌ Errar sinais (principalmente em seno e cosseno)  
- ❌ Integrar termo a termo de forma incorreta  
...
- 🔍 Sempre tente reconhecer padrões da tabela  
- ⚡ Simplifique a expressão antes de integrar  
- 📌 Integrais de soma → separam termo a termo  
- 🧠 Sempre confira derivando o resultado  
- 📚 Decore bem as integrais básicas  

---

## 🏁 Conclusão

As integrais indefinidas permitem reconstruir funções a partir de suas derivadas.

👉 Ideia central:

- Derivada → mostra a variação  
- Integral → reconstrói a função  

Dominar integrais é essencial para avançar em Cálculo II.
